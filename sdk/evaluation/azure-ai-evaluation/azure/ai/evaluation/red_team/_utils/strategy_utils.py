...
def strategy_converter_factory_map() -> Dict[Any, Union[PromptConverter, Callable, None]]:
    """
    Returns a mapping of attack strategies to their converters or factory functions.
    Factory functions are used for converters that need runtime dependencies.
    """
    return {
        ...
        AttackStrategy.Tense: create_tense_converter,  # Factory function instead of instance
...
def get_converter_for_strategy(
    ...
    factory_map = strategy_converter_factory_map()
